...
namespace SeumInput
{
    ...
    /// single label it draws. Whatever the HUD happened to set last frame then leaks into anything
    /// else that draws, which is why the panel came out centred, in the game's all-caps display
    /// font, and clipped at both ends.
    /// </summary>
    internal static class OverlayStyle
    {
        ...
        /// <summary>
        /// A monospaced face if the OS has one - the numbers in these panels are columns, and they
